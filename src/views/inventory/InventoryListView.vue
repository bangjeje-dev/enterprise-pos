  ...
  <div class="space-y-6">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center">
      ...
      <div class="flex items-center space-x-3 mt-4 sm:mt-0">
        ...
        <router-link to="/inventory/adjustments/new" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2">
          Adjust Stock
        </router-link>
      </div>
    </div>
